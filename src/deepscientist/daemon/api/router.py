...
ROUTES: list[tuple[str, re.Pattern[str], str]] = [
    ...
    ("GET", re.compile(r"^/api/quests/(?P<quest_id>[^/]+)/agents$"), "quest_agents"),
    ("GET", re.compile(r"^/api/quests/(?P<quest_id>[^/]+)/agents/(?P<agent_id>[^/]+)/config$"), "quest_agent_config_get"),
    ("PUT", re.compile(r"^/api/quests/(?P<quest_id>[^/]+)/agents/(?P<agent_id>[^/]+)/config$"), "quest_agent_config_put"),
